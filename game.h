...
class Game{
   ...
   private:
     ...
     enum Vi_tri_ve_chu{Vi_tri_ve_chu_trai,Vi_tri_ve_chu_giua,Vi_tri_ve_chu_phai};
     ...
     int  lay_ngau_nhien_1_so(int , int );
     ...
     unsigned char matrix_get(const unsigned char *, int , int , int );
     unsigned char xem_dong_da_day_chua(const unsigned char *, int , int );
     void matrix_set(unsigned char *, int , int , int , unsigned char );
     ...
     int so_dong_gioi_han_level(int , int);
